...
class AppThemeColors {
  ...
  static final light = AppThemeColors(
    ...
    scaffoldBackground: const Color(0xFFE8F5E9),
    unselectedWidget: Colors.grey.shade400,
    canvas: const Color(0xFFE8F5E9),
    splash: const Color(0xFFE8F5E9),
  ...
  static final dark = AppThemeColors(
    ...
    onError: Colors.white,
    success: Colors.green,
    scaffoldBackground: const Color(0xFF1B2A41),
    unselectedWidget: Colors.grey.shade600,
    canvas: const Color(0xFF1B2A41),
    splash: const Color(0xFF1B2A41),
    surfaceTint: Colors.transparent,
