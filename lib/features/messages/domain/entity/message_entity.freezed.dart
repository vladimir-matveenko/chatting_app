...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,chatId,senderId,type,body,replyToId,createdAt,updatedAt,deletedAt,isDeleted,const DeepCollectionEquality().hash(reactions),currentUserReaction,reply);

@override
String toString() {
  return 'MessageEntity(id: $id, chatId: $chatId, senderId: $senderId, type: $type, body: $body, replyToId: $replyToId, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, isDeleted: $isDeleted, reactions: $reactions, currentUserReaction: $currentUserReaction, reply: $reply)';
}
...
switch (_that) {
case _MessageEntity() when $default != null:
return $default(_that.id,_that.chatId,_that.senderId,_that.type,_that.body,_that.replyToId,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.isDeleted,_that.reactions,_that.currentUserReaction,_that.reply);case _:
  return orElse();
...
class _MessageEntity implements MessageEntity {
  const _MessageEntity({required this.id, required this.chatId, required this.senderId, required this.type, this.body, this.replyToId, required this.createdAt, required this.updatedAt, this.deletedAt, @JsonKey(defaultValue: false) required this.isDeleted, @JsonKey(defaultValue: []) required final  List<MessageReactionSummaryEntity> reactions, this.currentUserReaction, this.reply}): _reactions = reactions;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,chatId,senderId,type,body,replyToId,createdAt,updatedAt,deletedAt,isDeleted,const DeepCollectionEquality().hash(_reactions),currentUserReaction,reply);
