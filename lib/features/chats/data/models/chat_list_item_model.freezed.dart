...
mixin _$ChatListItemModel {
 ...
 String get id; ChatType get type; String? get title; String? get avatarUrl; String? get ownerId; DateTime get createdAt; DateTime get updatedAt; String? get lastReadMessageId; String? get lastMessageId; String? get lastMessagePreview; DateTime? get lastMessageAt; int get unreadCount; List<ChatListParticipantModel> get participants; int get participantsCount;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,type,title,avatarUrl,ownerId,createdAt,updatedAt,lastReadMessageId,lastMessageId,lastMessagePreview,lastMessageAt,unreadCount,const DeepCollectionEquality().hash(participants),participantsCount);

@override
String toString() {
  return 'ChatListItemModel(id: $id, type: $type, title: $title, avatarUrl: $avatarUrl, ownerId: $ownerId, createdAt: $createdAt, updatedAt: $updatedAt, lastReadMessageId: $lastReadMessageId, lastMessageId: $lastMessageId, lastMessagePreview: $lastMessagePreview, lastMessageAt: $lastMessageAt, unreadCount: $unreadCount, participants: $participants, participantsCount: $participantsCount)';
}
...
@useResult
$Res call({
 String id, ChatType type, String? title, String? avatarUrl, String? ownerId, DateTime createdAt, DateTime updatedAt, String? lastReadMessageId, String? lastMessageId, String? lastMessagePreview, DateTime? lastMessageAt, int unreadCount, List<ChatListParticipantModel> participants, int participantsCount
});
...
/// Create a copy of ChatListItemModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? type = null,Object? title = freezed,Object? avatarUrl = freezed,Object? ownerId = freezed,Object? createdAt = null,Object? updatedAt = null,Object? lastReadMessageId = freezed,Object? lastMessageId = freezed,Object? lastMessagePreview = freezed,Object? lastMessageAt = freezed,Object? unreadCount = null,Object? participants = null,Object? participantsCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  ChatType type,  String? title,  String? avatarUrl,  String? ownerId,  DateTime createdAt,  DateTime updatedAt,  String? lastReadMessageId,  String? lastMessageId,  String? lastMessagePreview,  DateTime? lastMessageAt,  int unreadCount,  List<ChatListParticipantModel> participants,  int participantsCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatListItemModel() when $default != null:
return $default(_that.id,_that.type,_that.title,_that.avatarUrl,_that.ownerId,_that.createdAt,_that.updatedAt,_that.lastReadMessageId,_that.lastMessageId,_that.lastMessagePreview,_that.lastMessageAt,_that.unreadCount,_that.participants,_that.participantsCount);case _:
  return orElse();
...
class _ChatListItemModel extends ChatListItemModel {
  const _ChatListItemModel({required this.id, required this.type, this.title, this.avatarUrl, this.ownerId, required this.createdAt, required this.updatedAt, this.lastReadMessageId, this.lastMessageId, this.lastMessagePreview, this.lastMessageAt, required this.unreadCount, required final  List<ChatListParticipantModel> participants, required this.participantsCount}): _participants = participants,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,type,title,avatarUrl,ownerId,createdAt,updatedAt,lastReadMessageId,lastMessageId,lastMessagePreview,lastMessageAt,unreadCount,const DeepCollectionEquality().hash(_participants),participantsCount);
