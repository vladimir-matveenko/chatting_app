...
@override
String toString() {
  return 'ChatMemberEntity(chatId: $chatId, userId: $userId, role: $role, joinedAt: $joinedAt, lastReadMessageId: $lastReadMessageId, isMuted: $isMuted, isArchived: $isArchived, displayName: $displayName, userName: $userName, avatarUrl: $avatarUrl, isOnline: $isOnline)';
}
...
class _ChatMemberEntity implements ChatMemberEntity {
  const _ChatMemberEntity({required this.chatId, required this.userId, required this.role, required this.joinedAt, this.lastReadMessageId, required this.isMuted, required this.isArchived, this.displayName, required this.userName, this.avatarUrl, required this.isOnline});
