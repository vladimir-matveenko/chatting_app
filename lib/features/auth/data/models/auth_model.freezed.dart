...
mixin _$AuthModel {
 ...
 UserModel get user; AuthTokenModel get tokens;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthModel&&(identical(other.user, user) || other.user == user)&&(identical(other.tokens, tokens) || other.tokens == tokens));
}
...
@override
String toString() {
  return 'AuthModel(user: $user, tokens: $tokens)';
}
...
@useResult
$Res call({
 UserModel user, AuthTokenModel tokens
});


$UserModelCopyWith<$Res> get user;$AuthTokenModelCopyWith<$Res> get tokens;
...
@override
@pragma('vm:prefer-inline')
$AuthTokenModelCopyWith<$Res> get tokens {
  
  return $AuthTokenModelCopyWith<$Res>(_self.tokens, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UserModel user,  AuthTokenModel tokens)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UserModel user,  AuthTokenModel tokens)  $default,) {final _that = this;
switch (_that) {
case _AuthModel():
return $default(_that.user,_that.tokens);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UserModel user,  AuthTokenModel tokens)?  $default,) {final _that = this;
switch (_that) {
case _AuthModel() when $default != null:
return $default(_that.user,_that.tokens);case _:
  return null;
...
class _AuthModel implements AuthModel {
  const _AuthModel({required this.user, required this.tokens});
  factory _AuthModel.fromJson(Map<String, dynamic> json) => _$AuthModelFromJson(json);

@override final  UserModel user;
@override final  AuthTokenModel tokens;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthModel&&(identical(other.user, user) || other.user == user)&&(identical(other.tokens, tokens) || other.tokens == tokens));
}
...
@override $UserModelCopyWith<$Res> get user;@override $AuthTokenModelCopyWith<$Res> get tokens;
